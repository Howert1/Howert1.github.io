const body = document.getElementById("mouse-body"); // the element from the html document
fetch("mouse.json") // fetching the information from the JSON that has all the information in it
